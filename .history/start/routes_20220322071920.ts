...
Route.group(() => {
  ...
  Route.post('/teachers/:teacherId/classroom/:classId/student/:studentId' , 'TeachersController.allocateStudent')
  Route.delete('/teachers/classroom/:classId/students/:studentId/' , 'TeachersController.removeStudentAllocate')
